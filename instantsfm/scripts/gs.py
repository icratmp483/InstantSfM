...
def run_gaussian_splatting():
    ...
    result_path = os.path.join(gs_args.data, 'gsplat')
    ...
    gs_cmd = f'python instantsfm/vis/gsplat_trainer.py default --data_dir {gs_args.data} --image_folder_name {image_folder_name} --data_factor 1 --result_dir {result_path} --close_viewer_after_training'
    # call the command
